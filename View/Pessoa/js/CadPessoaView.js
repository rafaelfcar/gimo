$(function(){
    ...
    $("#btnSalvarPessoa").click(function(){
        if ($.trim($("#nmePessoa").val())==''){
            $( "#dialogInformacao" ).jqxWindow('setContent', "Informe o nome da pessoa por favor!");
            $( "#dialogInformacao" ).jqxWindow("open");  
            return;
        } 
	...
	if (($("#codBairro").val()=='')||($("#codBairro").val()<=0)){
            $( "#dialogInformacao" ).jqxWindow('setContent', "<h4 style='text-align:center;'>Selecione um bairro</h4>");
            $( "#dialogInformacao" ).jqxWindow("open"); 
            return;
        }        
...
function MontaComboUf(ListarUf, sglUf){ 
    ...
    $("#sglUf").change(function(){
        CarregaComboCidade($(this).val(), -1, -1);
    });
}

function CarregaComboCidade(sglUf, codCidade, codBairro){
    $("#dialogInformacao").jqxWindow('setContent', "<h4 style='text-align:center;'>Aguarde, carregando Combo!<br><img src='../../Resources/images/carregando.gif' width='200' height='30'></h4>");
    $("#dialogInformacao" ).jqxWindow("open");    
    $.post('../../Controller/Cidade/CidadeController.php',
           ...
           function(ListarCidade){
                ...
                if (ListarCidade[0]==true){
                    MontaComboCidade(ListarCidade[1], codCidade, codBairro);
                    $( "#dialogInformacao" ).jqxWindow('close');
                }else{                    
...
function MontaComboCidade(ListarCidade, codCidade, codBairro){   
    $("#tdCidade").html('');
    ...
    $("#codCidade").change(function(){
        CarregaComboBairro($(this).val(), codBairro);
    });  
