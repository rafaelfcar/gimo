$(function(){    
    ...
    $("#rbAluguel").jqxRadioButton({ width: 70, height: 25, checked: true, theme: 'energyblue'});
    $("#rbVenda").jqxRadioButton({ width: 70, height: 25, theme: 'energyblue'});
