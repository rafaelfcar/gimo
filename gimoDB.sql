...
-- Dumping data for table gimo.en_bairro: ~3 rows (approximately)
...
INSERT INTO `en_bairro` (`COD_BAIRRO`, `COD_CIDADE`, `NME_BAIRRO`, `IND_ATIVO`) VALUES
	(1, 1, 'Asa Sul', NULL),
	(2, 2, 'Aguas Claras', 'S'),
	(3, 3, 'Vicente Pires', NULL),
	(4, 1, 'Taguatinga Sul', NULL),
...
-- Dumping data for table gimo.en_banco: ~2 rows (approximately)
...
-- Dumping data for table gimo.en_cidade: ~15 rows (approximately)
...
INSERT INTO `en_cidade` (`COD_CIDADE`, `SGL_UF`, `NME_CIDADE`, `IND_ATIVO`) VALUES
	(1, 'DF', 'Brasilia ', 'S'),
	(2, 'DF', 'Aguas claras', NULL),
	(3, 'DF', 'Vicente Pires', NULL),
	(4, 'DF', 'Taguatinga', 'S'),
	(5, 'DF', 'CeilÃ¢ndia', NULL),
	(6, 'DF', 'GuarÃ¡', NULL),
	(7, 'DF', 'NÃºcleo Bandeirante', NULL),
	(8, 'DF', 'Riacho Fundo', NULL),
	(9, 'DF', 'BrazlÃ¢ndia', NULL),
	(10, 'DF', 'Planaltina', NULL),
	(11, 'DF', 'Gama', NULL),
	(12, 'DF', 'Samambaia', NULL),
	(13, 'DF', 'Cruzeiro', NULL),
	(14, 'DF', 'Recanto das Emas', NULL),
	(15, 'DF', 'Sobradinho', NULL),
	(16, 'DF', 'Santa Maria', NULL),
...
-- Dumping data for table gimo.en_cliente: ~3 rows (approximately)
...
-- Dumping data for table gimo.en_detalhe: ~8 rows (approximately)
...
-- Dumping data for table gimo.en_imovel: ~3 rows (approximately)
...
-- Dumping data for table gimo.en_loja: ~3 rows (approximately)
DELETE FROM `en_loja`;
...
-- Dumping data for table gimo.en_noticias: ~1 rows (approximately)
...
-- Dumping data for table gimo.en_pessoas: ~5 rows (approximately)
...
-- Dumping structure for table gimo.en_tipo_pagamento
...
-- Dumping data for table gimo.en_tipo_pagamento: 3 rows
...
-- Dumping data for table gimo.en_uf: ~27 rows (approximately)
DELETE FROM `en_uf`;
...
-- Dumping data for table gimo.re_detalhe_imovel: ~14 rows (approximately)
...
-- Dumping data for table gimo.re_imovel_pagamento: ~4 rows (approximately)
...
INSERT INTO `re_imovel_pagamento` (`COD_IMOVEL`, `NRO_NOSSO_NUMERO`, `DTA_VENCIMENTO`, `DTA_PAGAMENTO`, `VLR_MENSALIDADE`, `NRO_DOCUMENTO`, `COD_TIPO_PAGAMENTO`, `VLR_PAGAMENTO`) VALUES
	...
	(2, '42143470', '2014-04-10', '2014-04-26', 1500, '26.201447.04', 2, 1520);
...
-- Dumping data for table gimo.re_imovel_pessoa: ~3 rows (approximately)
...
-- Dumping data for table gimo.re_permissao_perfil: ~10 rows (approximately)
...
-- Dumping data for table gimo.se_menu: ~30 rows (approximately)
DELETE FROM `se_menu`;
...
-- Dumping data for table gimo.se_menu_perfil: ~57 rows (approximately)
...
-- Dumping data for table gimo.se_perfil: ~4 rows (approximately)
...
-- Dumping data for table gimo.se_usuario: ~9 rows (approximately)
